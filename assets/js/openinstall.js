OpenInstall = function(e, n, t) {
    function r(n) {
        n = n || e.location.href;
        for (var t = n.indexOf("?"), r = -1 == t ? "" : n.substring(t + 1).replace(/\+/g, "%20"), i = r.split("&"), a = {}, o = 0; o < i.length; o++) {
            var c = i[o].split("="),
                u = decodeURIComponent(c[0] || ""),
                l = decodeURIComponent(c[1] || "");
            u && l && (void 0 === a[u] ? a[u] = l : "object" == typeof a[u] ? a[u].push(l) : a[u] = [a[u], l])
        }
        return a
    }
    ...
    function i(e) {
        ...
        for (var t in e) {
            ...
            if ("[object Array]" == Object.prototype.toString.call(r))
                for (var i = 0; i < r.length; i++) null != r[i] && void 0 !== r[i] && n.push(encodeURIComponent(t) + "=" + encodeURIComponent(r[i]));
    ...
    function c(e) {
        var n = new t,
            ...
            i = e.url,
            a = e.method;
        r && "string" != typeof r && (r = E.stringify(r)), "POST" != a && r && (i = i + (i.indexOf("?") > -1 ? "&" : "?") + r, r = null), n.onreadystatechange = function() {
            if (4 == n.readyState) {
                if (200 == n.status) {
        ...
        try {
            n.open(a, i, !1 !== e.async), n.withCredentials = !0;
            try {
    ...
    function u() {
        ...
        if (e && "function" == typeof e.getContext)
            for (var t = ["webgl", "webgl2", "experimental-webgl2", "experimental-webgl"], r = 0; r < t.length; r++) {
                ...
                if (a) {
                    var o = {};
                    o.context = i, o.version = a.getParameter(a.VERSION), o.vendor = a.getParameter(a.VENDOR), o.sl_version = a.getParameter(a.SHADING_LANGUAGE_VERSION), o.max_texture_size = a.getParameter(a.MAX_TEXTURE_SIZE);
    ...
    function l(n) {
        C(function(t) {
            var r, i, a, o;
            try {
                r = e.screen.width || "", i = e.screen.height || "", a = e.devicePixelRatio || "", o = u()
            } catch (e) {}
            for (var c = 0, t = t || [], l = t.length; c < l; c++) t[c] = v(t[c] || "");
            n({
                sw: v("" + (r || 0)),
                sh: v("" + (i || 0)),
                sp: a,
    ...
    function s(t, r, i) {
        ...
        for (var v, y, b = !1, C = r ? r + ((new Date).getTime() + (i || 1)) + "-" : null, h = 0; h < p.length; h++) {
            try {
                if (v = p[h], n.body.appendChild(v), "SELECT" === v.nodeName) v.focus();
                    ...
                    E || v.setAttribute("readonly", ""), v.select(), v.setSelectionRange(0, v.value.length), E || v.removeAttribute("readonly")
                } else {
                    v.hasAttribute("contenteditable") && v.focus(), C && v.setAttribute("class", C), y = e.getSelection();
                    var O = n.createRange();
                    O.selectNode(v), y.removeAllRanges(), y.addRange(O)
                }
                b = n[s](d)
            } catch (e) {
                b = !1
    ...
    var p = 2,
        h = function() {
            function e(e, n) {
                var t, r, a, o, c = -1,
                    u = e.length,
                    l = [0, 0, 0, 0];
                for (t = []; ++c < u;) r = e[c], a = e[++c], l[0] = r >> 2, l[1] = (3 & r) << 4 | (a || 0) >> 4, c >= u ? l[2] = l[3] = 64 : (o = e[++c], l[2] = (15 & a) << 2 | (o || 0) >> 6, l[3] = c >= u ? 64 : 63 & o), t.push(i.charAt(l[0]), i.charAt(l[1]), i.charAt(l[2]), i.charAt(l[3]));
                var s = t.join("");
                return n ? s.replace(/=/g, "") : s
            }

            function n(e) {
                for (var n, t, r, a, o, c, u, l = [], s = 0; s < e.length;) a = i.indexOf(e.charAt(s++)), o = i.indexOf(e.charAt(s++)), c = i.indexOf(e.charAt(s++)), u = i.indexOf(e.charAt(s++)), n = a << 2 | o >> 4, t = (15 & o) << 4 | c >> 2, r = (3 & c) << 6 | u, l.push(n), 64 != c && l.push(t), 64 != u && l.push(r);
                return l
            }
            ...
            function r(e) {
                var n, t, r, i = [],
                    a = 0;
                for (n = t = r = 0; a < e.length;) n = e[a], n < 128 ? (i.push(String.fromCharCode(n)), a++) : n > 191 && n < 224 ? (t = e[a + 1], i.push(String.fromCharCode((31 & n) << 6 | 63 & t)), a += 2) : (t = e[a + 1], r = e[a + 2], i.push(String.fromCharCode((15 & n) << 12 | (63 & t) << 6 | 63 & r)), a += 3);
                return i.join("")
            }
        ...
        C = function() {
            ...
            try {
                (a = e.RTCPeerConnection || e.mozRTCPeerConnection || e.webkitRTCPeerConnection) ? (c = new a({
                    iceServers: []
                }, {
                    optional: [{
                        RtpDataChannels: !0
            ...
            stringify: function() {
                ...
                return function t(a) {
                    ...
                    if ("object" == typeof a) {
                        ...
                        if (n(a)) {
                            for (var o = "[", c = 0; c < a.length; c++) o += (c ? ", " : "") + t(a[c]);
                            return o + "]"
                        }
        ...
        O = {
            frm: function(e) {
                ...
                t.style.display = "none", t.style.visibility = "hidden", t.src = e, n.body.appendChild(t)
            },
            loc: function(n) {
                e.location = n
            },
            hrf: function(e) {
                ...
                t.style.display = "none", t.href = e, n.body.appendChild(t), t.click()
            },
            inhrf: function(e) {
                var t = n.createElement("script");
                t.setAttribute("type", "text/javascript"), t.innerHTML = '(function(){var a = document.createElement("a");a.style.display = "none";a.href = "' + e.replace(/"/g, '\\"') + '";document.body.appendChild(a);a.click();})()', n.body.appendChild(t)
            },
            open: function(n) {
                e.open(n)
            }
        ...
        R = function(e, t) {
            ...
            function u(t) {
                ...
                if ("function" == typeof r && (r = r() || t), "string" == typeof r) {
                    ...
                    i.innerHTML = r, r = i.children[0]
                }
                var a = function() {
                    n.body.removeChild(r)
                };
                return r.addEventListener ? r.addEventListener("click", a) : r.onclick = a, r
            }
                ...
                function() {
                    ...
                    l(function(r) {
                        c({
                            ...
                            success: function(e) {
                                b(function() {
                                    e.sh && (v = u(e.sh)), g = e.fu, m = e.fm, C = e.ft, E = e.su, x = e.sm, A = e.st, S = e.ph ? y(e.ph) : null, I = e.pyp ? y(e.pyp) : null, w = e.pye ? parseInt(y(e.pye) || "0") : 0, k = e.dsoi, L = e.channelCode, N = e.csu;
                                    try {
                                        var n = e.images || [];
                                        if (n.length > 0)
    ...
    }, R.parseUrlParams = r, R.docReady = b, R.server = "//openinstall.io", R.wakeupOrInstall = function(e, n, t, r, i) {
        n ? f(e, n, function() {
            O[t](r)
        }, i) : O[t](r)
    }, R
